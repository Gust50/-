...
static const NSUInteger kMinTurn = 10;
...
- (void)reloadData {
    if (self.dataSource) {
        ...
        for (int i = 0; i < numberOfSlots; i++) {
            ...
            NSInteger scrollLayerTopIndex = - (i + kMinTurn + 10) * iconCount;
        ...
        [CATransaction setCompletionBlock:^{
            ...
            for (int i = 0; i < [_slotScrollLayerArray count]; i++) {
                ...
                for (CALayer *toBeDeletedLayer in toBeDeletedLayerArray) {
                    ...
                    CGFloat shiftY = slotIconsCount * toBeAddedLayer.frame.size.height * (kMinTurn + i + 1);
