...
{
    CLSHAccountPhoneNumModel *phoneNumModel;    ///<获取手机号码数据模型
...
- (void)modifyStyle
{
    ...
    self.numHeight.constant = 40*pro;
    self.describeTap.constant = 50*pro;
    self.describeHeight.constant = 21*pro;
    self.verTap.constant = 40*pro;
    self.verHeight.constant = 40*pro;
    
    self.codeLabelHeight.constant = 21*pro;
    self.codeLabelWidth.constant = 60*pro;
    self.getCodeWidth.constant = 90*pro;
    self.getCodeHeight.constant = 30*pro;
    self.bindIphoneLabel.font = [UIFont systemFontOfSize:14*pro];
    self.phoneNumber.font = [UIFont systemFontOfSize:20*pro];
    self.codeLabel.font = [UIFont systemFontOfSize:14*pro];
    self.numberTap.constant = 15*pro;
    self.numberHeight.constant = 21*pro;
    self.numberLabelTap.constant = 20*pro;
    self.numberLabelHeight.constant = 21*pro;
    self.backViewHeight.constant = 100*pro;
    self.viewHeight.constant = 50*pro;
    ...
    self.verification.titleLabel.font = [UIFont systemFontOfSize:15*pro];
    ...
    self.customerServiceNumber.titleLabel.font = [UIFont systemFontOfSize:20*pro];
    ...
    self.customerServiceNumber.imageEdgeInsets = UIEdgeInsetsMake(0, -20*pro, 0, 0);
    self.inputCode.borderStyle = UITextBorderStyleNone;
    self.inputCode.font = [UIFont systemFontOfSize:13*pro];
