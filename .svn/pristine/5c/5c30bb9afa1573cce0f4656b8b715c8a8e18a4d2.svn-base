...
-(UILabel *)defaultLabel
{
    if (!_defaultLabel) {
        ...
        _defaultLabel.font = [UIFont systemFontOfSize:18*pro];
    }
...
- (UILabel *)getWallet
{
    if (!_getWallet) {
        ...
        _getWallet.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)describe
{
    if (!_describe) {
        ...
        _describe.font = [UIFont systemFontOfSize:12*pro];
...
-(UIButton *)close
{
    if (!_close) {
        ...
        _close.layer.cornerRadius = 15.0*pro;
...
-(void)updateConstraints
{
    ...
    [_defaultLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(weakSelf.mas_left).offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).offset(-10*pro);
        make.bottom.equalTo(_getWallet.mas_top).offset(-10*pro);
    ...
    [_imageview mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(weakSelf.mas_left).offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).offset(-10*pro);
        make.bottom.equalTo(_backImage.mas_top).offset(50*pro);
        make.height.mas_equalTo(80*pro);
    }];
    
    [_describe mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.mas_centerX);
        make.top.equalTo(_getWallet.mas_bottom).offset(15*pro);
        make.left.equalTo(weakSelf.mas_left).offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).offset(-10*pro);
        make.height.mas_equalTo(15*pro);
    }];
    ...
    [_close mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.mas_centerX);
        make.top.equalTo(_describe.mas_bottom).offset(20*pro);
