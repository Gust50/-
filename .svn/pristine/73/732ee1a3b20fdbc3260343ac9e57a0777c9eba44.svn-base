...
//        KBImageToolViewController *imageTool=[[KBImageToolViewController alloc]initWithImage:image cropFrame:CGRectMake(0, 100.0f, self.view.frame.size.width, self.view.frame.size.width) scaleRatio:3.0];
//        imageTool.delegate=self;
//        [self presentViewController:imageTool animated:YES completion:nil];
    }];
}
