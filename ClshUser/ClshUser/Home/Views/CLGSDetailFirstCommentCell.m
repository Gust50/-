...
@interface CLGSDetailFirstCommentCell ()
...
@implementation CLGSDetailFirstCommentCell
...
-(void)updateConstraints{
    ...
    [_userIcon mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_firstComment.mas_bottom).with.offset(8*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(5*pro);
...
- (void)setProductDetailRemarkModel:(CLSHHomeProductDetailRemarkModel *)ProductDetailRemarkModel{
    ...
    self.firstComment.text = [NSString stringWithFormat:@"%ld",[ProductDetailRemarkModel.totalReviewCount integerValue]];
