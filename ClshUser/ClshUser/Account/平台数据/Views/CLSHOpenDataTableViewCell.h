...
@interface CLSHOpenDataTableViewCell : UITableViewCell

@property (nonatomic, strong)UIView *backView;
@property (nonatomic, strong)UILabel *userAddNumLabel;
@property (nonatomic, strong)UILabel *userSumLabel;
@property (nonatomic, strong)UIView *line1View;
@property (nonatomic, strong)UILabel *joinMerNumLabel;
@property (nonatomic, strong)UILabel *joinFacNumLabel;
