...
-(UITableView *)tableView{
    if (!_tableView) {
        _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 105*pro, SCREENWIDTH, SCREENHEIGHT-105*pro)];
...
- (void)viewDidLoad {
    ...
    //设置segment
    CLSHInviteCodeRecordHeader *header=[[CLSHInviteCodeRecordHeader alloc]initWithFrame:CGRectMake(0, 65, SCREENWIDTH, 50*pro)];
    WS(weakSelf);
