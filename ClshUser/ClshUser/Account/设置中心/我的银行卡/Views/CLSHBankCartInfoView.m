...
-(UILabel *)bankNameLabel{
    if (!_bankNameLabel) {
        ...
        _bankNameLabel.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)bankBranceLabel{
    if (!_bankBranceLabel) {
        ...
        _bankBranceLabel.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)bankNumberLabel{
    if (!_bankNumberLabel) {
        ...
        _bankNumberLabel.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)bankCartTypeLabel{
    if (!_bankCartTypeLabel) {
        ...
        _bankCartTypeLabel.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)name{
    if (!_name) {
        ...
        _name.font = [UIFont systemFontOfSize:14*pro];
        _name.text = @"赵云";
    }
    return _name;
}
...
-(UILabel *)bankName{
    if (!_bankName) {
        ...
        _bankName.font = [UIFont systemFontOfSize:14*pro];
        _bankName.text = @"中国银行";
...
-(UILabel *)bankBrance{
    if (!_bankBrance) {
        ...
        _bankBrance.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)bankNumber{
    if (!_bankNumber) {
        ...
        _bankNumber.font = [UIFont systemFontOfSize:14*pro];
...
-(UILabel *)bankCartType{
    if (!_bankCartType) {
        ...
        _bankCartType.font = [UIFont systemFontOfSize:14*pro];
...
-(void)updateConstraints{
    ...
    [_label1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_nameLabel.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
    ...
    [_bankNameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label1.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.size.mas_equalTo(CGSizeMake(60*pro, 20*pro));
    }];
    ...
    [_bankName mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label1.mas_bottom).with.offset(20*pro);
        make.left.equalTo(_bankNameLabel.mas_right).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(20*pro));
    }];
    
    [_label2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_bankNameLabel.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(1));
    }];
    ...
    [_bankBranceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label2.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.size.mas_equalTo(CGSizeMake(60*pro, 20*pro));
    }];
    ...
    [_bankBrance mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label2.mas_bottom).with.offset(20*pro);
        make.left.equalTo(_bankBranceLabel.mas_right).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(20*pro));
    }];
    
    [_label4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_bankBranceLabel.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(1));
    }];
    ...
    [_bankCartTypeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label4.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.size.mas_equalTo(CGSizeMake(60*pro, 20*pro));
    }];
    ...
    [_bankCartType mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label4.mas_bottom).with.offset(20*pro);
        make.left.equalTo(_bankCartTypeLabel.mas_right).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(20*pro));
    }];
    
    [_label3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_bankCartTypeLabel.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(1));
    }];
    ...
    [_bankNumberLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label3.mas_bottom).with.offset(20*pro);
        make.left.equalTo(weakSelf.mas_left).with.offset(10*pro);
        make.size.mas_equalTo(CGSizeMake(60*pro, 20*pro));
    }];
    ...
    [_bankNumber mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_label3.mas_bottom).with.offset(20*pro);
        make.left.equalTo(_bankNumberLabel.mas_right).with.offset(10*pro);
        make.right.equalTo(weakSelf.mas_right).with.offset(-10*pro);
        make.height.mas_equalTo(@(20*pro));
    }];
...
-(void)setAccountCardBankDetailListModel:(CLSHAccountCardBankDetailListModel *)accountCardBankDetailListModel
{
    _accountCardBankDetailListModel = accountCardBankDetailListModel;
    _name.text = accountCardBankDetailListModel.bankAccountName;
    _bankName.text = accountCardBankDetailListModel.bankCategory;
    _bankBrance.text = accountCardBankDetailListModel.bankBranchName;
    _bankNumber.text = accountCardBankDetailListModel.bankAccountNumber;
    if ([accountCardBankDetailListModel.bankType isEqualToString:@"debit"]) {
        _bankCartType.text = @"借记卡";
    }else if ([accountCardBankDetailListModel.bankType isEqualToString:@"credit"])
    {
        _bankCartType.text = @"信用卡";
    }else if ([accountCardBankDetailListModel.bankType isEqualToString:@"company"])
    {
