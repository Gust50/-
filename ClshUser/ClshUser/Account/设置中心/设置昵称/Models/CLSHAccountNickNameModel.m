...
@implementation CLSHAccountNickNameModel


-(void)fetchAccountNickNameModel:(NSDictionary *)params
                        callBack:(void (^)(BOOL, id))completion
{
    NSString *Url=[NSString stringWithFormat:@"%@%@",URL_Header,Account_NickName];
